var plugins = [{
      ...
      plugin: require('/workspaces/portifoli/node_modules/gatsby-plugin-theme-ui/gatsby-ssr.js'),
      options: {"plugins":[]},
    },{
      name: '@lekoarts/gatsby-theme-cara',
      plugin: require('/workspaces/portifoli/node_modules/@lekoarts/gatsby-theme-cara/gatsby-ssr.tsx'),
      options: {"plugins":[]},
    },{
      name: 'gatsby-plugin-manifest',
      plugin: require('/workspaces/portifoli/node_modules/gatsby-plugin-manifest/gatsby-ssr.js'),
      ...
      name: 'partytown',
      plugin: require('/workspaces/portifoli/node_modules/gatsby/dist/internal-plugins/partytown/gatsby-ssr.js'),
      options: {"plugins":[]},
    }]
/* global plugins */
